        ...
        <div className="grid lg:grid-cols-2 gap-16">
          <motion.div variants={fadeUp}>
            ...
            <div className="rounded-2xl border border-[#011032]/10 bg-[#011032] p-6 mb-6">
              ...
              <a href="mailto:info@cretostudio.com" className="font-display text-xl font-bold text-white hover:text-[#0185FA] transition-colors duration-300">info@cretostudio.com</a>
            </div>
